...
class Minority_Game_World(World):
    ...
    def setup(self):
        ...
        Minority_Game_World.nbr_last_strat_agents = SimEngine.gui_get(PREV_STRAT_AGENTS)
        Minority_Game_World.nbr_spying_strat_agents = SimEngine.gui_get(SPY_STRAT_AGENTS)
