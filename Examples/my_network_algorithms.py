...
from Examples.network_framework import (CLUSTER_COEFF, Graph_Node, Graph_World, LINK_PROB, PATH_LENGTH, RANDOM, RING,
                                        STAR, TBD, WHEEL, network_left_upper, network_right_upper)
...
class Graph_Algorithms_World(Graph_World):
    ...
    def link_nodes_for_graph(graph_type, nbr_nodes, ring_node_list):
        ...
        if graph_type == RANDOM:
            ...
            # Generate all the links but don't keep the list of links
...
if __name__ == '__main__':
    ...
    PyLogo(Graph_Algorithms_World, 'Network test', gui_left_upper=network_left_upper,
           gui_right_upper=network_right_upper, agent_class=Graph_Node, clear=True, bounce=True)
